...
# Spearman ρ / p / n (Overall, F, M) labeled
# ============================
...
# Plot correlation heatmap: ROIs (rows) × Tasks (cols)
library(corrplot)
...
# Keep only ROI–Task (exclude Task–Task)
